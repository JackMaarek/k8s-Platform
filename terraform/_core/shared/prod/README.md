...
Cross-domain cluster foundation for the **prod** environment. Provisions the VPC, EKS control plane, shared IAM roles, developer access, and compliance controls.
...
| `compliance.tf` | Compliance controls (profile: `hipaa`) |
